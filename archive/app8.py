...
def update_charts(machine, timeStart, timeEnd, lowerEnd, higherEnd):
    ...
    codesSixSeven = len(filtered_data[(filtered_data[1] < 25200) & (filtered_data[1] >= 21600)])
    codesSevenEight = len(filtered_data[(filtered_data[1] < 28800) & (filtered_data[1] >= 25200)])
    codesEightNine = len(filtered_data[(filtered_data[1] < 32400) & (filtered_data[1] >= 28800)])
    codesNineTen = len(filtered_data[(filtered_data[1] < 36000) & (filtered_data[1] >= 32400)])
    codesTenEleven = len(filtered_data[(filtered_data[1] < 39600) & (filtered_data[1] >= 36000)])
    codesElevenTwelve = len(filtered_data[(filtered_data[1] < 43200) & (filtered_data[1] >= 39600)])
    codesTwelveThirteen = len(filtered_data[(filtered_data[1] < 46800) & (filtered_data[1] >= 43200)])
    codesThirteenFourteen = len(filtered_data[(filtered_data[1] < 50400) & (filtered_data[1] >= 46800)])
    codesFourteenFifteen = len(filtered_data[(filtered_data[1] < 54000) & (filtered_data[1] >= 50400)])
    codesFifteenSixteen = len(filtered_data[(filtered_data[1] < 57600) & (filtered_data[1] >= 54000)])
    codesSixteenSeventeen = len(filtered_data[(filtered_data[1] < 61200) & (filtered_data[1] >= 57600)])
    codesSeventeenEighteen = len(filtered_data[(filtered_data[1] < 64800) & (filtered_data[1] >= 61200)])
    codesEighteenNineteen = len(filtered_data[(filtered_data[1] < 68400) & (filtered_data[1] >= 64800)])
    codesNineteenTwenty = len(filtered_data[(filtered_data[1] < 72000) & (filtered_data[1] >= 68400)])
    codesTwentyTwentyone = len(filtered_data[(filtered_data[1] < 75600) & (filtered_data[1] >= 72000)])
    codesTwentyoneTwentytwo = len(filtered_data[(filtered_data[1] < 79200) & (filtered_data[1] >= 75600)])
    codesTwentytwoTwentythree = len(filtered_data[(filtered_data[1] < 82800) & (filtered_data[1] >= 79200)])
    codesTwentythreeTwentyfour = len(filtered_data[(filtered_data[1] < 86400) & (filtered_data[1] >= 82800)])
    ...
    machine_throughput = {
        ...
        "layout": {
            "title": {"text": "Code Changes Per Hour For This Machine", "x": 0.05, "xanchor": "left"},
            "xaxis": {"fixedrange": True},
